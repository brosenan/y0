...
(all [v x cases t]
     ...
     (exist [tu]
            ...
            (exist [opts]
                   ...
                   (given (defall opts)
                          (all-options-are-uniquely-covered cases ! "in" x)))))

(all [cases]
     (all-options-are-uniquely-covered cases
                                       ! cases "is not a vector of cases"))

(all [case cases]
     (all-options-are-uniquely-covered [case & cases]) <-
     (this-and-other-options-are-uniquely-covered case cases))

(all []
     (all-options-are-uniquely-covered []))
...
(all [opt x cases]
     (this-and-other-options-are-uniquely-covered [:case_option opt x] cases) <-
     (exist [t]
            (option opt t))
     (all-options-are-uniquely-covered cases))
```
